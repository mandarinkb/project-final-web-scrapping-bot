...
import com.projectfinalwebscrappingbot.function.Md5;
import com.projectfinalwebscrappingbot.function.OtherFunc;

import redis.clients.jedis.Jedis;

@Service
public class ServicePremierLeagueImp implements ServicePremierLeague {
                        ...
                        if (eleChild.hasClass("daymatches")) {
                            ...
                            for (Element eleMatch : elesMatches) {
                                ...
                                if (!home.isEmpty()) {
                                    ...
                                    System.out.println(dateTimes.thaiDateTime() + " : insert present results PremierLeague complete");
                                }
                            }
                        }
                    }
                        ...
                        if (eleChild.hasClass("daymatches")) {
                            ...
                            for (Element eleMatch : elesMatches) {
                                ...
                                if (!home.isEmpty()) {
                                    ...
                                    json.put("away_img", baseLinkImg + awayImgUrl);      //โลโก้ทีมเยือน
                                    els.inputElasticsearch(json.toString(), indexName);
                                    System.out.println(dateTimes.thaiDateTime() + " : insert fixtures PremierLeague complete");
                                }
                            }
                        }
                    }
    ...
    @Override
    public void allTablePremierLeagueContent(String url, String indexName, String season, String baseLinkImg) {
        try {
            Document doc = Jsoup.connect(url).timeout(60 * 1000).get();
            ...
            for (Element eleResult : elesTrTag) {
                ...
                if (elesTeams.hasClass("team")) {
                    ...
                    for (Element eleTeam : elesTeam) {
                        if (eleTeam.tagName().equals("img")) {
                            ...
                            img = baseLinkImg + func.getNewLinkImage(img);
                ...
                json.put("season", season);                                                   //ฤดูกาล
                els.inputElasticsearch(json.toString(), indexName);
                System.out.println(dateTimes.thaiDateTime() + " : insert all-table PremierLeague complete");
            }
        } catch (IOException ex) {
            Logger.getLogger(ServicePremierLeagueImp.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    @Override
    public void homeTablePremierLeagueContent(String url, String indexName, String season, String baseLinkImg) {
        try {
            Document doc = Jsoup.connect(url).timeout(60 * 1000).get();
            ...
            for (Element eleResult : elesTrTag) {
                ...
                json.put("season", season);                                               //ฤดูกาล
                els.inputElasticsearch(json.toString(), indexName);
                System.out.println(dateTimes.thaiDateTime() + " : insert home-table PremierLeague complete");
            }
        } catch (IOException ex) {
            Logger.getLogger(ServicePremierLeagueImp.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    @Override
    public void awayTablePremierLeagueContent(String url, String indexName, String season, String baseLinkImg) {
        try {
            Document doc = Jsoup.connect(url).timeout(60 * 1000).get();
            ...
            for (Element eleResult : elesTrTag) {
                ...
                json.put("season", season);                                                  //ฤดูกาล
                els.inputElasticsearch(json.toString(), indexName);
                System.out.println(dateTimes.thaiDateTime() + " : insert away-table PremierLeague complete");
            }
    ...
    @Override
    public void allTablePremierLeague2014_2015Content(String url, String indexName, String season, String baseLinkImg) {
        try {
            Document doc = Jsoup.connect(url).timeout(60 * 1000).get();
            ...
            for (Element eleResult : elesTrTag) {
                ...
                json.put("season", season);                                                  //ฤดูกาล
                els.inputElasticsearch(json.toString(), indexName);
                System.out.println(dateTimes.thaiDateTime() + " : insert all-table PremierLeague2014_2015 complete");
            }
    ...
    public void statistics(String url, String indexName, String season, String baseLinkImg) {
        ...
        try {
            ...
            for (String idStats : listStats) {
                ...
                String title = ele.select(".statistics-title").text();
    ...
    @Override
    public void listTeamPremierLeague(String url, String indexName, String season, String detail, String baseLink) {
                        ...
                        if (elesDataPlayedFull != null) {
                            ...
                            for (int i = 0; i < (maxContent - 1); i++) {  // ไม่เอาค่า class content  สุดท้าย (content - 1)
                                ...
                                if (isGoalKeeper) {  // กรณีผู้รักษาประตู
                                    ...
                                    String editTeam  = func.changeTeamPremierLeague(season, team, club);
    ...
    public void presentTeamPremierLeague(String objRadis) {
        ...
        try {
            ...
            for (Element ele : eles) {
                json = new JSONObject();
                jsonPages = new JSONObject(); // เอาไว้ใช้งานต่อใน redis
                json.put("link", url);
                ...
                jsonPages.put("type", "present_teams_detail_premierleague");     // ประกาศเพื่อส่งต่อไปยังฟังก็ชันถัดไป
                
                redis.rpush("pages", jsonPages.toString());
                els.inputElasticsearch(json.toString(),"present_teams_premierleague");
                System.out.println(dateTimes.thaiDateTime() + " : insert present_teams_premierleague complete");   
            }
        } catch (IOException | JSONException e) {
    ...
    public void presentPlayerPremierLeague(String objRadis) {
        ...
        try {
            ...
            for (Element ele : eles) {
                ...
                jsonDetailPlayers.put("type", "present_players_detail_premierleague");    //ประแกาศเพื่อส่งต่อไปยังฟังก็ชันถัดไป
                
                arrDetailPlayers.put(jsonDetailPlayers);
                redis.rpush("pages", jsonDetailPlayers.toString());
            }
            json.put("players", arrDetailPlayers);
            els.inputElasticsearch(json.toString(), "present_teams_detail_premierleague");
            System.out.println(dateTimes.thaiDateTime() + " : insert present_teams_detail_premierleague complete"); 
        } catch (IOException | JSONException e) {
            System.out.println(e.getMessage());
        } 
        redis.close();
...
//+++++++++++รอการคำนวน++++++++++                        
            ...
            els.inputElasticsearch(json.toString(), "present_players_detail_premierleague");
            System.out.println(dateTimes.thaiDateTime() + " : insert present_players_detail_premierleague complete");
        } catch (IOException | JSONException e) {
            System.out.println(e.getMessage());
        }       
    ...
    public void getContentScoreAnalyzePage(String objRadis) {
        ...
        try {
            ...
            for (String contentlink : listPage) {
                ...
                els.inputElasticsearch(json.toString(), "score_analyze_premierleague");
                System.out.println(dateTimes.thaiDateTime() + " : insert score_analyze_premierleague complete");
            }
        } catch (IOException | JSONException e) {
            System.out.print(e.getMessage());
        }        
